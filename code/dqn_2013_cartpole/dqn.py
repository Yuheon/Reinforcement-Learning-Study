...
class DQN:
    def __init__(self, input_size: int, output_size: int, name: str = 'main') -> None:
        # The meaning of '->' is given in https://stackoverflow.com/questions/14379753/what-does-mean-in-python-function-definitions
        """DQN Agent can
    ...
    def _build_network(self, h_size=16) -> None:
        ...
        self.model = tf.keras.Sequential([
            tf.keras.layers.Dense(h_size,  activation='relu'),
